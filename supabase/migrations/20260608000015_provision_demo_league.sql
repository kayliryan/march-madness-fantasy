-- Section 14.5 Migration 2: atomically provisions a personal demo league for a
-- "Try as Commissioner" visitor. SECURITY DEFINER — callable by any authenticated
-- user via PostgREST (Section 14.3 accepted-risk note: only creates is_demo=true
-- leagues with no access to real data).
