...
export default function Signup() {
  ...
  // Google (and other OAuth) providers are not enabled on the production Supabase
  // project (auth settings show only email + anonymous_users enabled), so clicking
  // this button in prod fails with "Unsupported provider: provider is not enabled".
  // Gated behind NEXT_PUBLIC_ENABLE_OAUTH (unset/false by default) until OAuth is
  // configured; flip the env var to re-enable without a code change.
